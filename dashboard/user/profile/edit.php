...
<div class="col-12">
    <div class="dash-pro-item mb-30 mt-50 dashboard-widget">
        ...
        <div class="row mt-5">
			<form action="<?= ROOT ?>/dashboard/user/profile/edit.php" method="post" class="col-md-6 offset-md-3">
				...
				<div class="form-group">
					...
					<input type="tel" class="form-control" id="mobile" name="mobile" value="<?= $auth['mobile'] ?>" required>
				</div>
				<div class="form-group">
